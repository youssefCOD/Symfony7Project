 ...
 */
final class Version20241225212418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comments (id SERIAL NOT NULL, comments_id INT DEFAULT NULL, users_id INT NOT NULL, posts_id INT NOT NULL, content TEXT NOT NULL, is_reply BOOLEAN NOT NULL, PRIMARY KEY(id))');
